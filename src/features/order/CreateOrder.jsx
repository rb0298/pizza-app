  ...
  return (
    <div>
      ...
      <Form method="POST" action="/order/new">
        ...
        <div>
          <input
            className="h-6 w-6 accent-yellow-400 focus:outline-none focus:ring focus:ring-stone-400 focus:ring-offset-2 "
            type="checkbox"
            name="priority"
            id="priority"
            // value={withPriority}
        ...
        <div>
          <Button disabled={isSubmitting}>{isSubmitting?"Placing oreder...":'Order now'}</Button>
        </div>
      </Form>
    </div>
  );
